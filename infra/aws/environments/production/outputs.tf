...
output "kafka_bootstrap_brokers_tls" {
  description = "Kafka bootstrap brokers with TLS"
...
output "connection_info" {
  ...
  value = {
    ...
    api_base_url   = "https://${module.compute.alb_dns_name}/api/v1"
    health_check   = "https://${module.compute.alb_dns_name}/q/health"
    metrics        = "https://${module.compute.alb_dns_name}/metrics"
    swagger_ui     = "https://${module.compute.alb_dns_name}/q/swagger-ui"
  }
}
